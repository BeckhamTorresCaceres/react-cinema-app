...
import { Plus, Trash2, Edit3, Star, Eye, AlertTriangle, X } from "lucide-react";
import { createMovie, deleteMovie, getMovies, updateMovie, type MovieRecord } from "@/services/movies";
